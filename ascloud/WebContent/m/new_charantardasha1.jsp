...
<br /></div>
    ...
    for(int i = (pageNumber - 1) * cellsPerPage; i<=(pageNumber * cellsPerPage - 1); i++)
    {
        ...
        splittedLines = ADashaOutput[i].toString().split("\n");
        for(int j = 0; j<=splittedLines.length-1; j++)
        {
            ...
            if((arrLength.length + 1) == 10 && firstText.equals(true))
            	{
                %>
            ...
            else if((arrLength.length + 1)== 10 && firstText.equals(false))
            	{
                %><div class="textad"><b>
                <%
                firstText = "true";
...
<br />
   ...
   <a href="new_CharAntardasha-2.asp">Next</a><br /><br />
