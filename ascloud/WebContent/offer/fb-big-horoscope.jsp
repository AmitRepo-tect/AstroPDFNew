...
<body>
    <div class="ui-container buy-page">
        ...
        <div class="margin-b border-t">
            ...
            <div class="col-xs-12">
                <div align="center" class="btn-buy">
                    <a href="http://buy.astrosage.com/service/astrosage-big-horoscope?prtnr_id=FBEN" onclick='getEvents("snackbar", "buy-pdf");' class="btn btn-deep-orange card-shadow br-radius">
                        BUY NOW</a></div>
            </div>
            <div class="clearfix">
            </div>
        ...
        <div class="margin-t border-t margin-b">
            ...
            <div class="col-xs-12">
                <div align="center" class="btn-buy">
                    <a href="http://buy.astrosage.com/miscellaneous/astrosage-big-horoscope?prtnr_id=FBEN" onclick='getEvents("snackbar", "print-pdf");' class="btn btn-deep-orange card-shadow br-radius">
                        BUY NOW</a></div>
            </div>
            <div class="clearfix">
            </div>
