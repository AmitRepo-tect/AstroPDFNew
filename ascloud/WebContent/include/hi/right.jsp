<%@page import="com.ojassoft.astrosagecloud.util.SharedFunction"%>
    <%@include file='/controls/hi/i_download.jsp'%>
...
<div class="ui-margin-t border-t">
    <%@include file='/controls/hi/i_subscribe.jsp'%>
</div>
<% if(!true){%>
<div class="border-t">
    <%--@include file='/controls/hi/latestarticle-hi.jsp'--%>
</div>
<%}%>
<div class="ui-buybox">
    <%@include file='/controls/hi/i_buy.jsp'%>
</div>
<%if(!SharedFunction.Is_Mobile(request)){%>
<div class="ui-margin-t border-t">
...
<div class="ui-margin-t">
    <%@include file='/controls/hi/i_punit.jsp'%>
</div>
