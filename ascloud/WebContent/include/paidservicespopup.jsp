 ...
 <div id="modal-cloud-plan" class="modal model-bar ui-model-hgt">
         <div class="model-header amber darken-1">
           ...
           <%if(!SharedFunction.Is_Mobile(request)){%>&nbsp;<%=KEEP_IMP_CHARTS_NOTES%><%}else{%><%=AS_CLOUD%> <%}%>
            <a href="javascript:closePopup('cancel-paidplan','<%=tagval %>','paidserviceoverlay','modal-cloud-plan');" class="modal-close waves-effect btn-flat white-text right ui-close-btn"><i class="material-icons">close</i></a>  
            </h4>
                       ...
                       <div class="card-image cyan waves-effect">
                        ...
                        <div id="bPlan" <%if(Util.isMobileDevice(request)) {%> style="display:none"<%} %>>
                           ...
                           <div class="card-action center-align">
                              <button class="waves-effect waves-light btn modal-close" onclick="javascript:closePopup('cancel-paidplan','<%=tagval %>','paidserviceoverlay','modal-cloud-plan')"><%=SELECT_BASIC%></button>
                           </div>
                        </div>
                        </div>
                     </article>
                     ...
                     <article class="col s12 m6 l6 ui-cd">
                  	<div class="card">
                       ...
                       <div id="sPlan">
                           ...
                           <div class="card-action center-align">
                              <button name="submit" onclick="dhruvplanservice1();" value="" class="waves-effect waves-light btn light-pais-clr accent-2"><%=BUY_NOW%></button>
                           </div>
                        </div>
                        </div>
                     </article>
...
%>
               ...
               <form name="frmLoginBuyPlanmanual" id="frmLoginBuyPlanmanual" action="" method="post"> 
