...
Object objtc = session.getAttribute("constants");
MyProperties baseConstants = null;
if(objtc != null)
{
	baseConstants = (MyProperties) objtc;
}
else
{
	baseConstants = new MyProperties(local.loadPropertiesFile("constants", languageCode));
	session.setAttribute("constants", baseConstants);
}
%>
<html>
<head>
<title><%=baseConstants.getString("TERMS_CONDITIONS")%></title>
</head>
<div id="dialog-form-openDialogTerms" title="">    
    <fieldset>
        <form name="openDialogTerms" id="openDialogTerms" >
            <table>
                <tr>
                    <td>
                        <b>THE FOLLOWING SETS FORTH THE TERMS AND CONDITIONS UNDER WHICH ASTROSAGE.COM SERVICES
                        ...
                        TO THE TERMS AND CONDITIONS DESCRIBED HEREIN ("TERMS OF SERVICE").
                        <br />
                        <br />
                        ...
                        SIGNED BY BOTH YOU AND ASTROSAGE.COM</b>
                        <br />
                        <br />
                        ...
                        <br />
                        (D) THE SERVICES ARE PROVIDED FOR ENTERTAINMENT PURPOSES ONLY AND ASTROSAGE.COM,
                        ...
                        ANY GOODS OR SERVICES PURCHASED OR OBTAINED THROUGH ASTROSAGE.COM'S WEBSITE, OR
                        ANY TRANSACTIONS ENTERED INTO THROUGH ASTROSAGE.COM'S SITE, AND MAKES NO WARRANTY
                        ...
                        FROM ASTROSAGE.COM OR THROUGH THE SERVICES SHALL CREATE ANY WARRANTY.
                        <br />
                        <br />
                        9. LIMITATIONS OF LIABILITY. IN NO EVENT WILL ASTROSAGE.COM OR ITS SUPPLIERS BE
                        ...
                        OR THESE TERMS OF SERVICE (HOWEVER ARISING, INCLUDING NEGLIGENCE), EVEN IF ASTROSAGE.COM
                        HAD BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. WITHOUT LIMITING THE FOREGOING,
                        ASTROSAGE.COM AND ITS SUPPLIERS WILL NOT BE LIABLE FOR INDIRECT DAMAGES ARISING
                        OUT OF OR IN CONNECTION WITH:
                        <br />
                        (A) THE USE OF OR THE INABILITY TO USE THE SERVICES;
                        <br />
                        (B) ANY GOODS OR SERVICES PURCHASED OR OBTAINED THROUGH ASTROSAGE.COM'S SITE, OR
                        MESSAGES RECEIVED OR TRANSACTIONS ENTERED INTO THROUGH ASTROSAGE.COM'S SERVICES;
                        <br />
                        <br />
                        OR
                        <br />
                        ...
                        <br />
                        <br />
                        THE LIABILITY OF ASTROSAGE.COM AND ITS SUPPLIERS TO YOU OR ANY THIRD PARTIES ARISING
