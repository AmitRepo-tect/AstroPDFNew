...
function removedefault(lid, aid, aro) {
    ...
    for (var j = 0; j < spanlength; j++) {
        ...
        litem.getElementsByTagName('a').item(0).style.color = "#fff";
        litem.getElementsByTagName('i').item(0).style.borderTopColor = "#fff";
        toplist.getElementsByTagName('span').item(j).style.display = 'none';
    }
    document.getElementById(aro).style.borderTopColor = "#ffc"
    document.getElementById(aid).style.color = "#ffc";
