...
double temp=0,KPPlanetLongitude ,KPPlanetLongitude1,KPCuspLongitude,KPCuspLongitude1;
...
int[] home8 = new int[9];
int[] home9 = new int[9];
int[] home10 = new int[9];
int[] home11 = new int[9];
int[] home12 = new int[9];
//-----------------------
double[] temphome1 = new double[9];
double[] temphome2 = new double[9];
double[] temphome3 = new double[9];
double[] temphome4 = new double[9];
double[] temphome5 = new double[9];
double[] temphome6 = new double[9];
double[] temphome7 = new double[9];
double[] temphome8 = new double[9];
double[] temphome9 = new double[9];
double[] temphome10 = new double[9];
double[] temphome11 = new double[9];
double[] temphome12 = new double[9];
//----------------------------
int[] finalhome1 = new int[9];
int[] finalhome2 = new int[9];
int[] finalhome3 = new int[9];
int[] finalhome4 = new int[9];
int[] finalhome5 = new int[9];
int[] finalhome6 = new int[9];
int[] finalhome7 = new int[9];
int[] finalhome8 = new int[9];
int[] finalhome9 = new int[9];
int[] finalhome10 = new int[9];
int[] finalhome11 = new int[9];
int[] finalhome12 = new int[9];
...
for(int i=1;i<=12;i++)
{
	//out.println(myAstrologyObject.getName());
	KPPlanetLongitude = myAstrologyObject.getKPPlanetLongitude(i)/30;
	combined[i] = KPPlanetLongitude + 1;
	KPCuspLongitude = myAstrologyObject.getKPCuspLongitude(i) / 30; 
	combined[i+12] = KPCuspLongitude +1;
	KPPlanetLongitude1 = myAstrologyObject.getKPPlanetLongitude(i);
	combined1[i]    = KPPlanetLongitude1;
	KPCuspLongitude1 = myAstrologyObject.getKPCuspLongitude(i);
	combined1[i + 12] = KPCuspLongitude1;
}
