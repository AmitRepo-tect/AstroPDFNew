...
<%  
	...
	MyResourceBundle sadeSatiConstants = (MyResourceBundle) local.loadPropertiesFileNew("sadesatireport", languageCode);

	int[] ArrayLagnaChartRashiPositions = myAstrologyObject.getPositionForShodasvarg(0);
...
ArraySaniEndDate[242] = 21380106	;
	...
	cal.set(Calendar.DATE, myAstrologyObject.getDayOfBirth());
	cal.set(Calendar.MONTH, myAstrologyObject.getMonthOfBirth()-1);
	cal.set(Calendar.YEAR, myAstrologyObject.getYearOfBirth());
...
<title>Sade Sati Report</title>
</HEAD>

<div class="hdg-lg card">
	<h1><%=sadeSatiConstants.getString("SADESATI_REPORT") %></h1>	
</div>
...
<div class="row mrt-30 ">
					...
					<Th><B><%=baseConstants.getString("NAM")%></B></Th>
					<Th><%=myAstrologyObject.getName()%></Th>
					<Th></Th>
					<Th></Th>
				</TR>
				</thead>
				<TR>
					<TD><B><%=baseConstants.getString("BIRTH")%>&nbsp; <%=baseConstants.getString("DATAM") %></B></TD>
					<TD>
						<%out.println(myAstrologyObject.getDayOfBirth() + " : " + myAstrologyObject.getMonthOfBirth() +" : "+	myAstrologyObject.getYearOfBirth());%>
					</TD>
					<TD><B><%=baseConstants.getString("BIRTH")%>&nbsp; <%=baseConstants.getString("TIMAR")%></B></TD>
					<TD><%=myAstrologyObject.getHourOfBirth() + " : " + myAstrologyObject.getMinuteOfBirth() +" : "+  myAstrologyObject.getSecondOfBirth()%></TD>
				</TR>
				<TR>
					<TD><B><%=baseConstants.getString("PLACE_OF_BIRTH")%></B></TD>
					<TD><%=myAstrologyObject.getPlace()%></TD>
					<TD></TD>
					<TD></TD>
				</TR>
				<TR>
					<TD><B><%=baseConstants.getString("GENDR")%></B></TD>
					<TD><%=baseConstants.getString(myAstrologyObject.getMaleFemale().toUpperCase())%></TD>
					<TD><B><%=baseConstants.getString("TITHI")%></B></TD>
					<TD><%=hindi.unicode(myAstrologyObject.getTithiName(), languageCode)%></TD>
				</TR>
				<TR>
					<TD><B><%=baseConstants.getString("RASHI")%></B></TD>
					<TD><%=hindi.unicode(myAstrologyObject.getRasiName(), languageCode)%></TD>
					<TD><B><%=baseConstants.getString("NAKSHATRA") %></B></TD>
					<TD><%=hindi.unicode(myAstrologyObject.getNakshatraName(), languageCode)%></TD>
				</TR>
                                 </table>
                                 </div>
                                 </div>
                         ...
                         <div class="row mrt-30 planet-table ">
                           <div class="col s12 l12 ui-btm ui-btm-zero">
                              <div class="card table-panel">
                                 ...
                                 <thead> 
                                 <TR class="amber lighten-5">
			<TH id="PlanetaryTableTD" class="cellhead"><%=baseConstants.getString("S_N")%></TH>
			<TH id="PlanetaryTableTD" class="cellhead"><%=sadeSatiConstants.getString("SADESATI") %>/<%=sadeSatiConstants.getString("PANOTI")%></TH>
			<TH id="PlanetaryTableTD" class="cellhead"><%=sadeSatiConstants.getString("SHANI")%> <%=baseConstants.getString("RASHI")%></TH>
			<TH id="PlanetaryTableTD" class="cellhead"><%=sadeSatiConstants.getString("START")%></TH>
			<TH id="PlanetaryTableTD" class="cellhead"><%=sadeSatiConstants.getString("END_DATE") %></TH>
			<TH id="PlanetaryTableTD" class="cellhead"><%=sadeSatiConstants.getString("PHASE")%></TH>
		</TR>
		</thead> 
		<%
   ...
   String TempDate1 = myAstrologyObject.getMonthOfBirth()+"/"+myAstrologyObject.getDayOfBirth()+"/"+myAstrologyObject.getYearOfBirth();
   ...
   // out.println(Tempvariable4);
	for(int i = 0;i<=Tempvariable4;i++)
	{
		...
		%>
		<TR>
			<TD id="PlanetaryTableTD" class="cellcontent"><%=i+1%></TD>
			<TD id="PlanetaryTableTD" class="cellcontent"><%=CombinedPanotiAndSadeSati[i]%></TD>
			<TD id="PlanetaryTableTD" class="cellcontent"><%=baseConstants.getString(CombinedPanotiSadeSatiRashi[i].toUpperCase())%></TD>
   ...
   //out.println(arrPrintStartDate);
	...
	out.println(baseConstants.getString(arrPrintStartDate[0].toUpperCase())+" "+arrPrintStartDate[1]+arrPrintStartDate[2]);
%>
    ...
    out.println(baseConstants.getString(arrPrintEndDate[0].toUpperCase())+" "+arrPrintEndDate[1]+arrPrintEndDate[2]);
	%>
			</TD>
			<TD id="PlanetaryTableTD" class="cellcontent">
...
<h2> <%=sadeSatiConstants.getString("SHANI") %>&nbsp;<%=sadeSatiConstants.getString("SADESATI") %>
						:
						<%=sadeSatiConstants.getString("RISING")%>&nbsp;<%=sadeSatiConstants.getString("PHASE") %></h2>
						
						<p><%=sadeSatiConstants.getString("SADESATIRISINGPHASE")%></p>
						
						<h2> <%=sadeSatiConstants.getString("SHANI") %>&nbsp;<%=sadeSatiConstants.getString("SADESATI") %>:
						<%=sadeSatiConstants.getString("PEAK")%>
						&nbsp;<%=sadeSatiConstants.getString("PHASE") %></h2>
						
						<p><%=sadeSatiConstants.getString("SADESATIPEAKPHASE")%></p>
						
						<h2> <%=sadeSatiConstants.getString("SHANI") %>&nbsp;<%=sadeSatiConstants.getString("SADESATI") %>:
						<%=sadeSatiConstants.getString("SETTING")%>
						&nbsp;<%=sadeSatiConstants.getString("PHASE") %></h2>
						
						<p><%=sadeSatiConstants.getString("SADESATISETTINGPHASE")%></p> <br>
						
						<p>
						<b><%=baseConstants.getString("NOTE") %>:</b><%=sadeSatiConstants.getString("IMPNOTE")%></p>
