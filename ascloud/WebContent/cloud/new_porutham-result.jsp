...
%>
<!--#include file = "util/local.asp"-->
<!--#include file = "util/getallconstants.asp"-->
<!--#include file = "util/languagecode.asp"-->
<!--#include file = "util/util.asp"-->
<!--#include file = "serverside-validation.asp"-->
<!--#include file = "util/porutham-matching-function.asp"-->
<!--#include file = "constant-values.asp"-->
<!--#include virtual='/sharedfunction.asp'-->
<body>
...
<script language="JavaScript" type="text/javascript">
    $("#chart").append(myval);
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                <tr>
                    ...
                    <td align="center" class="hoverme">
                        <a href="../../freeKundali/matchmakingSession.asp?name=<%=objHoroMale.getName()%>&place=<%=place1 %>&TimeZone=<%=timezone1 %>&sex=<%=sex1 %>&sec=<%=sec1 %>&min=<%=min1 %>&hrs=<%=hrs1 %>&Day=<%=day1 %>&month=<%=month1 %>&Year=<%=year1 %>&LatDeg=<%=latdeg1 %>&LongDeg=<%=longdeg1 %>&LatMin=<%=latmin1 %>&LongMin=<%=longmin1 %>&LongEW=<%=longew1 %>&LatNS=<%=latns1 %>&DST=<%=dst1 %>&languageCode=0&Ayanamsa=<%="0" %>&kphn=<%="0" %>&Charting=<%="0" %>&referrer=<%="/freekundali/love-horoscope.asp" %>">
                            <img id="tooltip2" src="../../freeKundali/images/report_icon/love.png">
                            <span class="ui-tooltip">
                                <%=extraPagesConstants.getString("READ")%>&nbsp;<%=objHoroMale.getName() %><%=extraPagesConstants.getString("LOVE_REPORT")%>
                            </span></a>
                    </td>
                    <td align="center" class="hoverme">
                        <a href="../../freeKundali/matchmakingSession.asp?name=<%=objHoroMale.getName()%>&place=<%=place1 %>&TimeZone=<%=timezone1 %>&sex=<%=sex1 %>&sec=<%=sec1 %>&min=<%=min1 %>&hrs=<%=hrs1 %>&Day=<%=day1 %>&month=<%=month1 %>&Year=<%=year1 %>&LatDeg=<%=latdeg1 %>&LongDeg=<%=longdeg1 %>&LatMin=<%=latmin1 %>&LongMin=<%=longmin1 %>&LongEW=<%=longew1 %>&LatNS=<%=latns1 %>&DST=<%=dst1 %>&languageCode=0&Ayanamsa=<%="0" %>&kphn=<%="0" %>&Charting=<%="0" %>&referrer=<%="/freekundali/gemstones-report.asp" %>">
                            <img id="tooltip3" src="../../freeKundali/images/report_icon/gemstone.png">
                            <span class="ui-tooltip">
                                <%=extraPagesConstants.getString("READ")%>&nbsp;<%=objHoroMale.getName() %><%=extraPagesConstants.getString("GEMSTONE_REPORT")%>
                            </span></a>
                    </td>
                    <td align="center" class="hoverme">
                        <a href="../../freeKundali/matchmakingSession.asp?name=<%=objHoroMale.getName()%>&place=<%=place1 %>&TimeZone=<%=timezone1 %>&sex=<%=sex1 %>&sec=<%=sec1 %>&min=<%=min1 %>&hrs=<%=hrs1 %>&Day=<%=day1 %>&month=<%=month1 %>&Year=<%=year1 %>&LatDeg=<%=latdeg1 %>&LongDeg=<%=longdeg1 %>&LatMin=<%=latmin1 %>&LongMin=<%=longmin1 %>&LongEW=<%=longew1 %>&LatNS=<%=latns1 %>&DST=<%=dst1 %>&languageCode=0&Ayanamsa=<%="0" %>&kphn=<%="0" %>&Charting=<%="0" %>&referrer=<%="/freekundali/dasha_phala.asp" %>">
                            <img id="tooltip4" src="../../freeKundali/images/report_icon/ico_dasha.png">
                            <span class="ui-tooltip">
                                <%=extraPagesConstants.getString("READ")%>&nbsp;<%=objHoroMale.getName() %><%=extraPagesConstants.getString("DASHA_PREDICTION")%>
                            </span></a>
                    </td>
                    <td align="center" class="hoverme">
                        <a href="../../freeKundali/matchmakingSession.asp?name=<%=objHoroMale.getName()%>&place=<%=place1 %>&TimeZone=<%=timezone1 %>&sex=<%=sex1 %>&sec=<%=sec1 %>&min=<%=min1 %>&hrs=<%=hrs1 %>&Day=<%=day1 %>&month=<%=month1 %>&Year=<%=year1 %>&LatDeg=<%=latdeg1 %>&LongDeg=<%=longdeg1 %>&LatMin=<%=latmin1 %>&LongMin=<%=longmin1 %>&LongEW=<%=longew1 %>&LatNS=<%=latns1 %>&DST=<%=dst1 %>&languageCode=0&Ayanamsa=<%="0" %>&kphn=<%="0" %>&Charting=<%="0" %>&referrer=<%="/freekundali/lalkitab-prediction.asp" %>">
                            <img id="tooltip5" src="../../freeKundali/images/report_icon/ico_lalkitab.png">
                            <span class="ui-tooltip">
                                <%=extraPagesConstants.getString("READ")%>&nbsp;<%=objHoroMale.getName() %><%=extraPagesConstants.getString("LAL_KITAB_PREDICTION")%>
                            </span></a>
                    </td>
                    <td align="center" class="hoverme">
                        <a href="../../freeKundali/matchmakingSession.asp?name=<%=objHoroMale.getName()%>&place=<%=place1 %>&TimeZone=<%=timezone1 %>&sex=<%=sex1 %>&sec=<%=sec1 %>&min=<%=min1 %>&hrs=<%=hrs1 %>&Day=<%=day1 %>&month=<%=month1 %>&Year=<%=year1 %>&LatDeg=<%=latdeg1 %>&LongDeg=<%=longdeg1 %>&LatMin=<%=latmin1 %>&LongMin=<%=longmin1 %>&LongEW=<%=longew1 %>&LatNS=<%=latns1 %>&DST=<%=dst1 %>&languageCode=0&Ayanamsa=<%="0" %>&kphn=<%="0" %>&Charting=<%="0" %>&referrer=<%="/freekundali/VarshphalAllPages.asp" %>">
                            <img id="tooltip6" src="../../freeKundali/images/report_icon/ico_2011_report.png">
                            <span class="ui-tooltip">
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                <tr>
                    ...
                    <td align="center" class="hoverme">
                        <a href="../../freeKundali/matchmakingSession.asp?name=<%=objHoroFemale.getName()%>&place=<%=place2 %>&TimeZone=<%=timezone2 %>&sex=<%=sex2 %>&sec=<%=sec2%>&min=<%=min2 %>&hrs=<%=hrs2 %>&Day=<%=day2 %>&month=<%=month2 %>&Year=<%=year2 %>&LatDeg=<%=latdeg2 %>&LongDeg=<%=longdeg2 %>&LatMin=<%=latmin2 %>&LongMin=<%=longmin2 %>&LongEW=<%=longew2 %>&LatNS=<%=latns2 %>&DST=<%=dst2 %>&languageCode=0&Ayanamsa=<%="0" %>&kphn=<%="0" %>&Charting=<%="0" %>&referrer=<%="/freekundali/home.asp" %>">
                            <img id="tooltip7" src="../../freeKundali/images/report_icon/ico_mangal.png" alt="<%=objHoroFemale.getName() %><%=extraPagesConstants.getString("KUjA_DOSHAM_CONSIDERATIONS")%>" />
                            <span class="ui-tooltip">
                    ...
                    <td align="center" class="hoverme">
                        <a href="../../freeKundali/matchmakingSession.asp?name=<%=objHoroFemale.getName()%>&place=<%=place2 %>&TimeZone=<%=timezone2 %>&sex=<%=sex2 %>&sec=<%=sec2%>&min=<%=min2 %>&hrs=<%=hrs2 %>&Day=<%=day2 %>&month=<%=month2 %>&Year=<%=year2 %>&LatDeg=<%=latdeg2 %>&LongDeg=<%=longdeg2 %>&LatMin=<%=latmin2 %>&LongMin=<%=longmin2 %>&LongEW=<%=longew2 %>&LatNS=<%=latns2 %>&DST=<%=dst2 %>&languageCode=0&Ayanamsa=<%="0" %>&kphn=<%="0" %>&Charting=<%="0" %>&referrer=<%="/freekundali/home.asp" %>">
                            <img id="tooltip8" src="../../freeKundali/images/report_icon/ico_sadesati.png">
                            <span class="ui-tooltip">
                    ...
                    <td align="center" class="hoverme">
                        <a href="../../freeKundali/matchmakingSession.asp?name=<%=objHoroFemale.getName()%>&place=<%=place2 %>&TimeZone=<%=timezone2 %>&sex=<%=sex2 %>&sec=<%=sec2%>&min=<%=min2 %>&hrs=<%=hrs2 %>&Day=<%=day2 %>&month=<%=month2 %>&Year=<%=year2 %>&LatDeg=<%=latdeg2 %>&LongDeg=<%=longdeg2 %>&LatMin=<%=latmin2 %>&LongMin=<%=longmin2 %>&LongEW=<%=longew2 %>&LatNS=<%=latns2 %>&DST=<%=dst2 %>&languageCode=0&Ayanamsa=<%="0" %>&kphn=<%="0" %>&Charting=<%="0" %>&referrer=<%="/freekundali/home.asp" %>">
                            <img id="tooltip10" src="../../freeKundali/images/report_icon/love.png" />
                            <span class="ui-tooltip">
                    ...
                    <td align="center" class="hoverme">
                        <a href="../../freeKundali/matchmakingSession.asp?name=<%=objHoroFemale.getName()%>&place=<%=place2 %>&TimeZone=<%=timezone2 %>&sex=<%=sex2 %>&sec=<%=sec2%>&min=<%=min2 %>&hrs=<%=hrs2 %>&Day=<%=day2 %>&month=<%=month2 %>&Year=<%=year2 %>&LatDeg=<%=latdeg2 %>&LongDeg=<%=longdeg2 %>&LatMin=<%=latmin2 %>&LongMin=<%=longmin2 %>&LongEW=<%=longew2 %>&LatNS=<%=latns2 %>&DST=<%=dst2 %>&languageCode=0&Ayanamsa=<%="0" %>&kphn=<%="0" %>&Charting=<%="0" %>&referrer=<%="/freekundali/home.asp" %>">
                            <img id="tooltip11" src="../../freeKundali/images/report_icon/gemstone.png" />
                            <span class="ui-tooltip">
                    ...
                    <td align="center" class="hoverme">
                        <a href="../../freeKundali/matchmakingSession.asp?name=<%=objHoroFemale.getName()%>&place=<%=place2 %>&TimeZone=<%=timezone2 %>&sex=<%=sex2 %>&sec=<%=sec2%>&min=<%=min2 %>&hrs=<%=hrs2 %>&Day=<%=day2 %>&month=<%=month2 %>&Year=<%=year2 %>&LatDeg=<%=latdeg2 %>&LongDeg=<%=longdeg2 %>&LatMin=<%=latmin2 %>&LongMin=<%=longmin2 %>&LongEW=<%=longew2 %>&LatNS=<%=latns2 %>&DST=<%=dst2 %>&languageCode=0&Ayanamsa=<%="0" %>&kphn=<%="0" %>&Charting=<%="0" %>&referrer=<%="/freekundali/home.asp" %>">
                            <img id="tooltip12" src="../../freeKundali/images/report_icon/ico_dasha.png" />
                            <span class="ui-tooltip">
                    ...
                    <td align="center" class="hoverme">
                        <a href="../../freeKundali/matchmakingSession.asp?name=<%=objHoroFemale.getName()%>&place=<%=place2 %>&TimeZone=<%=timezone2 %>&sex=<%=sex2 %>&sec=<%=sec2%>&min=<%=min2 %>&hrs=<%=hrs2 %>&Day=<%=day2 %>&month=<%=month2 %>&Year=<%=year2 %>&LatDeg=<%=latdeg2 %>&LongDeg=<%=longdeg2 %>&LatMin=<%=latmin2 %>&LongMin=<%=longmin2 %>&LongEW=<%=longew2 %>&LatNS=<%=latns2 %>&DST=<%=dst2 %>&languageCode=0&Ayanamsa=<%="0" %>&kphn=<%="0" %>&Charting=<%="0" %>&referrer=<%="/freekundali/home.asp" %>">
                            <img id="tooltip13" src="../../freeKundali/images/report_icon/ico_lalkitab.png" />
                            <span class="ui-tooltip">
                    ...
                    <td align="center" class="hoverme">
                        <a href="../../freeKundali/matchmakingSession.asp?name=<%=objHoroFemale.getName()%>&place=<%=place2 %>&TimeZone=<%=timezone2 %>&sex=<%=sex2 %>&sec=<%=sec2%>&min=<%=min2 %>&hrs=<%=hrs2 %>&Day=<%=day2 %>&month=<%=month2 %>&Year=<%=year2 %>&LatDeg=<%=latdeg2 %>&LongDeg=<%=longdeg2 %>&LatMin=<%=latmin2 %>&LongMin=<%=longmin2 %>&LongEW=<%=longew2 %>&LatNS=<%=latns2 %>&DST=<%=dst2 %>&languageCode=0&Ayanamsa=<%="0" %>&kphn=<%="0" %>&Charting=<%="0" %>&referrer=<%="/freekundali/home.asp" %>">
                            <img id="tooltip14" src="../../freeKundali/images/report_icon/ico_2011_report.png" />
                            <span class="ui-tooltip">
        ...
        <div class="pull-left ui-margin-tl">
                        ...
                        <a href="../porutham.asp" class="btn btn-secondary btn-mid"><span class="glyphicon glyphicon-circle-arrow-left">
                        </span>
