		...
		<table>
			<tr>
				<td style="text-align:center;"><a href="vimshottaridasha.asp"
					...
					<a href="VMAD&PD&SD2.asp"
					class="waves-effect white-text waves-light btn amber darken-4 box-shadow"><%=vimshottartiConstants.getString("BACK")%></a>
					<a href="VMAD&PD&SD4.asp"
					class="waves-effect white-text waves-light btn amber darken-4 box-shadow"><%=vimshottartiConstants.getString("NEX")%></a>
				</td>
			</tr>
