...
<%@page import="com.cslsoftware.yoginidasa.*"%>
...
<%
    ...
    int  pagenum=1;
    int iLowerLimit = 0;     //When Page Number is "1"
    int iUpperLimit = 11;
    if(String.valueOf(session.getAttribute("languageCode")).equals("1")){
...
<div class="card table-panel rt-custom"> 
   ...
   <a href="yoginidasha2.asp"  class="waves-effect waves-light btn amber darken-4 box-shadow"><%=rbConstants.getString("NEX") %></a>
   </div>
   </div>
   </div>
