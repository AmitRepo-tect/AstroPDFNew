...
<p> <%=dao.getPredictionForAspect(0,"CHARACTER", myAstrologyObject, langCode, hindi, connObj )%></p>
</div>
...
<p> <%=dao.getPredictionForAspect(0,"HAPPINESS AND FULFILLMENT", myAstrologyObject, langCode, hindi, connObj )%></p>
</div>
<div class="card padding-all hdg-content mrt-20 justify">
<h2> <%=rBPredCharHoro.getString("LIFE_STYLE")%></h2>
<p> <%=dao.getPredictionForAspect(0,"LIFE STYLE", myAstrologyObject, langCode, hindi, connObj )%></p>
</div>
<div class="card padding-all center mrt-20 mrb-10"> 
<a href="prediction2.asp" class="waves-effect waves-light btn amber darken-4 box-shadow"><%=rBConstants.getString("NEX")%> </a> </div>
