		...
		<table>
			<tr>
				<td style="text-align:center;">
				    <a href="vimshottaridasha.asp" class="waves-effect white-text waves-light btn amber darken-4 box-shadow"><%=vimshottartiConstants.getString("MENU")%></a>
					<a href="VMAD&PD5.asp" class="waves-effect waves-light btn amber white-text darken-4 box-shadow"><%=vimshottartiConstants.getString("BACK")%></a>
					<a href="VMAD&PD&SD2.asp" class="waves-effect waves-light btn white-text amber darken-4 box-shadow"><%=vimshottartiConstants.getString("NEX")%></a>
				</td>
			</tr>
